...
/* BINDTOOL_HEADER_FILE_HASH(7fd829905856bc9618239dd1978d9329)                     */
/***********************************************************************************/
...
void bind_usrp_tx_rx(py::module& m)
{
    ...
    py::class_<usrp_tx_rx, gr::block, gr::basic_block, std::shared_ptr<usrp_tx_rx>>(
        m, "usrp_tx_rx", D(usrp_tx_rx))
